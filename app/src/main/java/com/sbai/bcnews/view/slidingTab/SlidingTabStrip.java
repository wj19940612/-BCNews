...
class SlidingTabStrip extends LinearLayout {
    ...
    private boolean mWeightEqual = true;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (childCount > 0) {
            ...
            int textPaddingLeft = selectedTitle.getPaddingLeft();
            int textPaddingRight = selectedTitle.getPaddingRight();
            ...
            if (mWeightEqual) {
                ...
                canvas.drawRect(left + textPaddingLeft, height - mSelectedIndicatorThickness, right - textPaddingRight,
                        height, mSelectedIndicatorPaint);
            }
        }
    ...
    public void setWeightEqual(boolean weightEqual) {
        mWeightEqual = weightEqual;
    }

...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabViewTextColor = ContextCompat.getColorStateList(getContext(), R.color.sliding_tab_text);
        mTabViewTextSize = TAB_VIEW_TEXT_SIZE_SP;
        mTabViewPadding = TAB_VIEW_PADDING_DIPS * getResources().getDisplayMetrics().density;
    ...
    /**
     * 设置默认 tabview 中文字 padding
     *
     * @param tabViewPadding
     */
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        int padding = (int) mTabViewPadding;

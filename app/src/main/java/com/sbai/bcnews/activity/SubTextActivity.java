...
//        }
    ...
    private void updateData(NewsDetail newsDetail){
        mSubtitle.setText(mNewsDetail.getTitle());
        mSource.setText(mNewsDetail.getSource());
//        mPubTime.setText(DateUtils.formatDefaultStyleTime(mNewsDetail.getId()));
